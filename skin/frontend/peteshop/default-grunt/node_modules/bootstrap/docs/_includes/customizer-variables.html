...
<div class="row">
  ...
  <div class="bs-customizer-input">
    <label for="input-@orange">@orange</label>
    <input id="input-@orange" type="text" value="#FFA248" data-var="@orange" class="form-control"/>
  </div>
  <div class="bs-customizer-input">
...
<div class="row">
  ...
  <div class="bs-customizer-input">
    ...
    <input id="input-@link-color" type="text" value="@gray-light" data-var="@link-color" class="form-control"/>
    <p class="help-block">Global textual link color.</p>
  </div>
  <div class="bs-customizer-input">
    <label for="input-@link-hover-color">@link-hover-color</label>
    <input id="input-@link-hover-color" type="text" value="darken(@orange, 15%)" data-var="@link-hover-color" class="form-control"/>
...
<div class="row">
  ...
  <div class="bs-customizer-input">
    ...
    <input id="input-@font-family-base" type="text" value="@font-family-monospace" data-var="@font-family-base" class="form-control"/>
  </div>
  <div class="bs-customizer-input">
  ...
  <div class="bs-customizer-input">
    ...
    <input id="input-@headings-font-family" type="text" value="@font-family-sans-serif" data-var="@headings-font-family" class="form-control"/>
...
<div class="row">
  ...
  <div class="bs-customizer-input">
    ...
    <input id="input-@navbar-default-color" type="text" value="#000" data-var="@navbar-default-color" class="form-control"/>
  </div>
  <div class="bs-customizer-input">
    <label for="input-@navbar-default-bg">@navbar-default-bg</label>
    <input id="input-@navbar-default-bg" type="text" value="#FFF" data-var="@navbar-default-bg" class="form-control"/>
  </div>
  <div class="bs-customizer-input">
    <label for="input-@navbar-default-border">@navbar-default-border</label>
    <input id="input-@navbar-default-border" type="text" value="#FFF" data-var="@navbar-default-border" class="form-control"/>
  </div>
  <div class="bs-customizer-input">
    <label for="input-@navbar-default-link-color">@navbar-default-link-color</label>
    <input id="input-@navbar-default-link-color" type="text" value="#333" data-var="@navbar-default-link-color" class="form-control"/>
  </div>
  <div class="bs-customizer-input">
    <label for="input-@navbar-default-link-hover-color">@navbar-default-link-hover-color</label>
    <input id="input-@navbar-default-link-hover-color" type="text" value="@orange" data-var="@navbar-default-link-hover-color" class="form-control"/>
  </div>
  <div class="bs-customizer-input">
  ...
  <div class="bs-customizer-input">
    ...
    <input id="input-@navbar-default-link-active-color" type="text" value="darken(@orange, 10%)" data-var="@navbar-default-link-active-color" class="form-control"/>
  </div>
  <div class="bs-customizer-input">
    <label for="input-@navbar-default-link-active-bg">@navbar-default-link-active-bg</label>
    <input id="input-@navbar-default-link-active-bg" type="text" value="transparent" data-var="@navbar-default-link-active-bg" class="form-control"/>
  </div>
  <div class="bs-customizer-input">
