...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    rename: {
      renameBoostrapCssFile: {
        src: 'dist/css/bootstrap.css',
        dest: 'dist/css/_bootstrap.scss'
      }
    },
  ...
  grunt.registerTask('dist-css', ['less-compile', 'autoprefixer', 'usebanner', 'csscomb', 'cssmin', 'rename']);
